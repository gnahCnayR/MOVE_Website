...
import herobackground from '../images/skyline.png';
                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in" style={contentStyle}>
                    ...
                    <div className="flex flex-col lg:flex-row py-8 justify-between text-center">
                        <div className="flex flex-col justify-end px-8" data-aos="zoom-in" data-aos-delay="200">
                            <h1 className="mb-5 md:text-6xl text-4xl font-bold text-white">
                                Welcome to MOVE
                            </h1>
                            <div className="text-2xl font-semibold tracking-tight mb-5 mt-4 text-white">where business meets social entrepreneurship</div>
