            ...
            <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 bg-gray-200">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold text-center lg:text-left custom-text-color uppercase text-4xl">Send us a message</h1>
                        </div>
                        ...
                        <div
                            className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto custom-bg-color rounded-2xl">
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-gray-400">University of Southern California</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: -----------</p>
                            ...
                            <div className='mt-5'>
                                ...
                                <p className="text-gray-400">usc.move@gmail.com</p>
                            </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        <a href="https://www.instagram.com/move.usc/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
                            <img src={instagram} alt="Instagram" className='text-blue-900 mb-4' width="50" height="50"/>
                        </a>
                        <a href="https://www.linkedin.com/groups/12578274/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
